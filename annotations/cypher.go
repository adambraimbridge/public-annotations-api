...
func (cd cypherDriver) read(contentUUID string) (anns annotations, found bool, err error) {
	...
	query := &neoism.CypherQuery{
		Statement: `
			...
			WITH c, rel, cc, collect({id: parent.uuid, predicate: 'IS_CLASSIFIED_BY', types: labels(parent), prefLabel: parent.prefLabel, leiCode: null, prefUUID: null, canonicalPrefLabel: null, canonicalLEI: null, canonicalTypes: null, lifecycle: rel.lifecycle}) as rows
